...
#include "../../PathTrace/PtSrisPipeline.hpp"
#include "../../PathTrace/GenerateLightSample.hpp"

#include "../../LightSample/WA_LightSample.hpp"
#include "../../LightSample/LightSampleDesc.hpp"
...
public:
    ...
    // pt sris
    Irori::PathTrace::UniquePtSrisPipeline pt_sris_pipeline;
    Irori::PathTrace::UniqueGenLSPipeline pt_gen_ls_pipeline;
    
    // light sample
    WA_LightSample::LightSampleBuiler light_sample_builder;
    WA_LightSample::LightSampleDesc light_sample_desc;
